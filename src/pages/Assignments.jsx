  ...
  const startUpload = () => {
    ...
    const interval = setInterval(() => {
      ...
      if (currentProgress >= 100) {
        ...
        if (simulateError) {
          setUploading(false);
          setError("Connection timeout. BJ Security gateway rejected the payload. Please try again.");
        } else {
          setUploading(false);
          setSuccess(true);
    ...
    <div className="space-y-8 animate-in text-left relative min-h-screen pb-12">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-1.5">
          ...
          <h1 className="text-3xl font-black text-premium-heading leading-tight tracking-tight mt-1">Assignments Desk</h1>
        ...
        <div className="flex items-center gap-3">
          <Button 
            ...
            className="h-11 text-xs font-black uppercase tracking-widest bg-white border border-premium-border text-slate-500 shadow-sm cursor-pointer"
          >
        ...
        <div className="lg:col-span-2 space-y-6">
          {assignmentsState.map((assignment, index) => {
            ...
            return (
              ...
              >
                <GlassCard className="group border border-premium-border bg-white p-6 shadow-sm hover:shadow-[0_12px_45px_rgba(15,23,42,0.04)] hover:border-premium-accent/20 transition-all duration-300 rounded-3xl">
                    ...
                    <div className="shrink-0 self-start">
                      <div className={`w-14 h-14 rounded-2xl flex items-center justify-center border shadow-sm ${
                        isGraded 
                          ...
                          ? 'bg-red-50 border-red-100 text-red-500 animate-pulse-slow'
                          : isSubmitted
                          ? 'bg-blue-50 border-blue-100 text-premium-accent'
                          : 'bg-amber-50 border-amber-100/60 text-amber-500'
                      }`}>
                    ...
                    <div className="flex-1 text-left space-y-4">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                        <div className="space-y-0.5">
                          <h3 className="text-lg font-black text-premium-heading group-hover:text-premium-accent transition-colors leading-snug">
                            {assignment.title}
                          </h3>
                        ...
                        <div className="bg-slate-50 border border-slate-100 rounded-2xl p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="text-left">
                              <p className="text-xs font-black text-premium-heading max-w-[240px] truncate">{assignment.submittedFile.name}</p>
                          ...
                          {assignment.submittedFile.feedback && (
                            <div className="flex items-start gap-2 bg-amber-50/50 border border-amber-100/50 p-2.5 rounded-xl text-left w-full sm:w-auto sm:max-w-xs shrink-0">
                        ...
                        <div className="flex items-center gap-2.5">
                          {assignment.status === 'Pending' || assignment.status === 'Revision Requested' ? (
                            ...
                            <Button 
                              ...
                              size="sm" 
                              onClick={() => openUploadModal(assignment)}
                              className="text-[10px] uppercase tracking-wider font-black h-10 px-4 border border-premium-border bg-white text-slate-500 hover:bg-slate-50 shadow-sm cursor-pointer"
                            >
                              Review File
                            </Button>
                          )}
        ...
        <div className="space-y-6">
          <GlassCard className="border border-premium-border bg-white p-6 shadow-sm rounded-3xl">
            ...
            <Button 
              ...
              className="w-full mt-8 text-xs font-black uppercase tracking-widest h-11 bg-white border border-premium-border text-slate-500 hover:bg-slate-50 shadow-sm cursor-pointer"
            >
          ...
          <GlassCard className="bg-gradient-premium border-none relative overflow-hidden flex flex-col justify-between h-48 shadow-lg p-6 rounded-3xl">
             ...
             <Button 
               ...
               className="w-full bg-white text-blue-600 hover:bg-white/95 text-xs font-black uppercase tracking-widest h-11 shadow-sm mt-4 cursor-pointer"
             >
        ...
        {selectedAssignment && (
          ...
          >
            <motion.div
              ...
              className="bg-white border border-premium-border/80 rounded-3xl w-full max-w-lg overflow-hidden shadow-2xl relative p-8 flex flex-col gap-6"
            >
              {/* Premium Glow decor */}
              ...
              <div className="text-left space-y-1.5 pr-8">
                ...
                <h2 className="text-xl font-black text-premium-heading leading-tight">{selectedAssignment.title}</h2>
              ...
              {selectedAssignment.submittedFile && selectedAssignment.submittedFile.feedback && (
                <div className="bg-amber-50 border border-amber-100 rounded-2xl p-4 text-left flex gap-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-amber-700 font-semibold leading-relaxed">{selectedAssignment.submittedFile.feedback}</p>
                  </div>
                </div>
              )}
              ...
              <div className="w-full text-center">
                  ...
                  <div
                    ...
                    className={`border-2 border-dashed rounded-2xl p-8 flex flex-col items-center justify-center cursor-pointer transition-all duration-300 ${
                      dragActive 
                        ...
                        : 'border-slate-200 bg-slate-50/50 hover:bg-slate-50 hover:border-premium-accent/50'
                    }`}
                  >
                    <input 
                      type="file" 
                    ...
                    <div className="w-14 h-14 bg-blue-50/80 border border-blue-100 rounded-2xl flex items-center justify-center mb-4 text-premium-accent shadow-sm group-hover:scale-105 transition-transform">
                      <UploadCloud className="w-7 h-7" />
                    </div>

                    <div className="space-y-1">
                      <p className="text-xs font-black text-premium-heading">Drag and drop your solution file</p>
                ...
                {file && !uploading && !success && !error && (
                  <div className="space-y-5">
                    <div className="bg-slate-50 border border-slate-100 rounded-2xl p-5 flex items-center justify-between gap-4 text-left">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="text-left max-w-[260px]">
                          <p className="text-xs font-black text-premium-heading truncate">{file.name}</p>
                    ...
                    <div className="flex items-center justify-between bg-slate-50 border border-slate-100 px-4 py-3.5 rounded-2xl text-left">
                ...
                {uploading && (
                  <div className="bg-slate-50 border border-slate-100 rounded-2xl p-6 space-y-4 text-left">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2.5">
                        <RefreshCw className="w-4 h-4 text-premium-accent animate-spin" />
                        <span className="text-xs font-black text-premium-heading uppercase tracking-wider">Encrypting & Uploading...</span>
                      </div>
                    ...
                    <p className="text-[10px] text-slate-400 font-bold leading-normal">
                      Submitting encrypted case packet to BJ Review boards. Do not close this drawer.
                    </p>
                    ...
                    <Button 
                      ...
                      className="w-full text-[10px] uppercase font-black tracking-wider bg-white h-10 rounded-xl cursor-pointer"
                    >
                      Cancel Submission
                    </Button>
                  </div>
                ...
                {error && (
                  <div className="space-y-4">
                    <div className="bg-red-50 border border-red-100 rounded-2xl p-5 text-left flex gap-3">
                ...
                {success && !uploading && !error && (
                  <div className="space-y-5">
                    <div className="bg-green-50 border border-green-100 rounded-2xl p-6 text-left flex gap-4">
                      <div className="w-10 h-10 bg-green-100/50 border border-green-200 rounded-xl flex items-center justify-center text-green-600 shrink-0">
                    ...
                    <div className="bg-slate-50 border border-slate-100 rounded-2xl p-4 flex gap-3 text-left">
                      ...
                      <div className="space-y-0.5">
                        <p className="text-[11px] font-black text-premium-heading uppercase tracking-wider">Syllabus Status: Submitted</p>
                        <p className="text-[10px] text-slate-400 font-bold leading-normal">
