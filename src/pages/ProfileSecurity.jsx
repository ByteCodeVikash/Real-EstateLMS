  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 animate-in text-left">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-3xl font-black text-premium-heading mb-2">Security & Devices</h1>
          <p className="text-sm text-slate-400 font-bold">Manage your account security and authorized devices.</p>
        </div>
        <div className="flex items-center gap-2">
          <Badge variant="success" className="py-2 px-4 flex items-center gap-2 rounded-xl text-[10px] font-black uppercase tracking-wider bg-green-50 border border-green-100 text-green-600 shadow-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <GlassCard className="lg:col-span-1 bg-white border border-premium-border p-6 shadow-sm rounded-2xl">
          <h3 className="text-xl font-black text-premium-heading mb-8">Security Strength</h3>
          <div className="flex flex-col items-center justify-center text-center py-6">
            <div className="relative w-40 h-40 flex items-center justify-center mb-6">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <span className="text-4xl font-black text-premium-heading">85%</span>
            ...
            <div className="w-full space-y-3">
              <div className="flex items-center justify-between text-xs p-3.5 bg-slate-50 border border-premium-border rounded-xl shadow-sm text-slate-600 font-bold">
        ...
        {/* Device Management */}
        <GlassCard className="lg:col-span-2 bg-white border border-premium-border p-6 shadow-sm rounded-2xl text-left">
          <div className="flex items-center justify-between mb-8">
            <h3 className="text-xl font-black text-premium-heading">Authorized Devices</h3>
          ...
          <div className="space-y-4">
            {mockData.devices.map((device) => (
              <div key={device.id} className="p-5 rounded-2xl border border-premium-border bg-slate-50/50 flex items-center justify-between group hover:border-premium-accent/20 transition-all shadow-sm">
                <div className="flex items-center gap-6">
                  <div className="w-14 h-14 bg-white border border-premium-border flex items-center justify-center rounded-2xl shadow-sm group-hover:scale-105 transition-transform">
                    <device.icon className="w-7 h-7 text-slate-400 group-hover:text-premium-accent" />
                  </div>
                  <div>
                    <div className="flex items-center gap-2 mb-1.5">
                      <p className="font-bold text-premium-heading">{device.name}</p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Button variant="ghost" size="icon" className="h-9 w-9 text-red-500 hover:bg-red-50 hover:text-red-600 rounded-lg border border-transparent hover:border-red-100 shadow-none">
          ...
          <div className="mt-8 p-6 rounded-2xl bg-blue-50/50 border border-blue-100 flex items-start gap-4 shadow-sm">
        ...
        {/* Login Activity */}
        <GlassCard className="lg:col-span-3 bg-white border border-premium-border p-6 shadow-sm rounded-2xl">
          <h3 className="text-xl font-black text-premium-heading mb-8">Recent Login Activity</h3>
              ...
              <tbody className="divide-y divide-slate-100">
                {[
                  ...
                  <tr key={i} className="group hover:bg-slate-50/50 transition-colors">
                    <td className="py-4 px-4 font-bold text-premium-heading text-sm">{row.browser}</td>
